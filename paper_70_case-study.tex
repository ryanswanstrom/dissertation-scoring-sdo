...
\section{CASE STUDY: SCORING AN SDO OF A LARGE FINANCIAL INSTITUTION}
    ...
    \subsection{QUALITY}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[scale=.28]{images/quality_scores.png}
    ...
    \subsection{AVAILABILITY}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[scale=.28]{images/availability_scores.png}
    ...
    \label{sec:case-req}
        ...
        \begin{figure}[hbt]
            \centering
            \includegraphics[scale=.28]{images/requirements_scores.png}
