...
\section{MASTER PERFORMANCE INDICATOR (MPI)}
    ...
    \subsection{ELEMENTS OF MPI}
        ...
        \subsubsection{SATISFACTION}
            ...
            than actracting new customers \cite{Aulet2013}.  
            Depending upon the type of SDO,
            the customers may be internal or external to the organization.
            If one element of MPI was to be rated as the most important, satisfaction
            would be it.  Without satisfied customers, the rest of the measures do not matter.
            For example, having a quality
            application that is always available does not matter if it is not what the customer
            wants.  Surveys are used to measure satisfaction for MPI.
            
            
            \paragraph{SURVEYS}
                Write possible survey questions here.
                and explain the issues with surveys, see qualifier
