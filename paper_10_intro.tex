...
\section{INTRODUCTION}
    ...
    score is based upon data collected for five key result indicators
...
\subsection{PREVIOUS SOFTWARE EVALUATION WORK}
    ...
    presence of various techniques. Two examples of such techniques are: 
    ...
    many processes.  Numerous logs of raw data are collected.  
...
\subsubsection{SEMAT}
    ...
    \begin{enumerate}
        \item \textbf{Measurement} - There must exist a means to 
            determine the health and progress of an endeavour.
        \item \textbf{Categorization} -  The activities must progress 
            through categories during an endeavour.
        \item \textbf{Competencies} - Specific competencies will 
...
\subsubsection{SOFTWARE QUALITY}
    ...
    the goal is to decrease the number of problems with the software.
    ...
    more chances for problems. Some numerical measures for the 
...
\label{subsub:softwareanalytics}
    ...
    The term software intelligence was proposed for the field of study
    ...
    Later, Martin Shepperd in \cite{Hassan2013} identified three important questions that software
    ...
    \end{enumerate}
    These are three important questions that should be addressed 
    ...
    presented in this dissertation will address both the three main focus areas and
    the three important questions of software analytics.
    ...
    data and tools exist, the analytics should help an
    ...
    Some of the benefits of gamification are higher productivity, added competition,
    ...
    evaluate portions of an SDO.  None of the attempts provide
...
\subsection{ORGANIZATION OF THE WORK}
    ...
    The remainder of this dissertation is divided into seven chapters.  Chapter 2 provides
