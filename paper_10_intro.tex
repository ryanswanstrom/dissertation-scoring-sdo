...
\subsection{ORGANIZATION OF THE WORK}
    ...
    software engineering. Chapter 4 then provides an explanation of the Cumulative
    ...
    a technological framework for generating and storing the current and historical CRI values.
